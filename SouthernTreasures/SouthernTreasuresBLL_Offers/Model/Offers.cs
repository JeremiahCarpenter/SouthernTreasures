using System;
namespace SouthernTreasuresBLL.Offers.Model
{
    public class OffersBLLModel
    {
        private int _ID;
        ...
        public OffersBLLModel(int ID, int UserID_Nbr, int ProductID_Nbr, decimal Price_Dec, DateTime Submitted_DtTm)
        {
            this.ID = ID;
