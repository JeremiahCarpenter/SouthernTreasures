namespace SouthernTreasuresDAL.Products.Model
{
    public class ProductsDALModel
    {
        ...
        public ProductsDALModel(int ID, int UserID_Nbr, int CategoryID_Nbr, string Name_Txt, string Description_Txt, decimal MinPrice_Dec)
        {
            this.ID = ID;
