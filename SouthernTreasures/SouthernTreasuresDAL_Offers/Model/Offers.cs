using System;
namespace SouthernTreasuresDAL.Offers.Model
{
    public class OffersDALModel
    {
        private int _ID;
        ...
        public OffersDALModel(int ID, int UserID_Nbr, int ProductID_Nbr, decimal Price_Dec, DateTime Submitted_DtTm)
        {
            this.ID = ID;
