namespace SouthernTreasuresDAL.Users.Model
{
    public class UsersDALModel
    {
        private int _ID;
        ...
        public UsersDALModel(int ID, string Name_Txt, string Password_Txt, string Email_Txt, decimal Money_Dec)
        {
            this.ID = ID;
